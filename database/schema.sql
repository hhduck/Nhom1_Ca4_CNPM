...
(1, 
 'Entremets Rose', 
 1, 
 '<p>Một chiếc entremets tựa như đoá hồng nở trong nắng sớm — nhẹ nhàng, tinh khôi và ngọt ngào theo cách riêng. 
 Entremets Rose là sự hòa quyện giữa vải thiều mọng nước, mâm xôi chua thanh, phô mai trắng béo mịn và hương hoa hồng phảng phất, tạo nên cảm giác trong trẻo, nữ tính và đầy tinh tế.</p>
 <p>Bánh được hoàn thiện với những nguyên liệu tuyển chọn kỹ lưỡng: trái cây tươi nhập khẩu, kem phô mai mềm mượt, cốt bánh nướng thủ công và lớp mousse mịn nhẹ như mây. 
 Mỗi muỗng bánh là một lát cắt của sự thanh thoát — dịu dàng mà vẫn đọng lại dư vị khó quên.</p>
 <p>Một món bánh không chỉ để thưởng thức, mà còn để cảm nhận — như một bông hồng ngọt ngào mang hồn vị của <b>La Cuisine Ngọt</b>.</p>', 
 650000, 
 750000, 
 15, 
 'available', 
 'assets/images/entremets-rose.jpg', 
 500, 
 3, 
 TRUE, 
 '<b>Hoa hồng – Vải thiều – Mâm xôi – Phô mai trắng</b>', 
 'Chiếc entremets nhẹ như một khúc nhạc Pháp, hòa quyện hương hoa hồng thanh thoát, vải thiều ngọt mát, mâm xôi chua nhẹ và mousse phô mai trắng béo mềm. 
 Từng lớp bánh được sắp đặt tỉ mỉ để mang đến cảm giác trong trẻo, tinh khôi và đầy nữ tính — một "nụ hồng ngọt ngào" dành cho những tâm hồn yêu sự dịu dàng.', 
 '<ul>
 ...
 <p>Trang trí bằng hoa edible, mâm xôi tươi và lớp xịt nhung trắng (velours) — tinh khôi, thanh lịch, mang đậm dấu ấn <b>La Cuisine Ngọt</b>.</p>', 
 '<ul class="no-dot">
   <li>Bảo quản bánh trong hộp kín, giữ ở ngăn mát tủ lạnh (2–6°C) để đảm bảo hương vị và kết cấu tốt nhất.</li>
 ...
 '<ul class="no-dot">
   ...
   <li>Thiệp cảm ơn <b>La Cuisine Ngọt</b> – gửi gắm lời chúc ngọt ngào kèm thông điệp từ trái tim.</li>
 </ul>'
);
(2, 
 'Lime and Basil Entremets', 
 1, 
 '<p>Bánh Entremets Chanh – Húng Quế là sự hòa quyện hoàn hảo giữa vị chua dịu của chanh vàng tươi và hương thơm thanh khiết của lá húng quế. 
 Lớp mousse chanh mịn màng, vừa tươi vừa nhẹ, được điểm xuyết bằng những lá húng quế nghiền nhẹ, tạo cảm giác tươi mới và thanh thoát.</p>
 <p>Đế bánh giòn rụm cân bằng vị chua, mang đến sự cân bằng giữa ngon miệng và tinh tế, khiến mỗi miếng bánh là một trải nghiệm vị giác độc đáo và khó quên.</p>
 ...
 12, 
 'available', 
 'assets/images/lime-and-basil-entremets.jpg', 
 500, 
 3, 
 TRUE, 
 '<b>Chanh, Húng Quế và Kem Tươi</b>', 
 'Chiếc entremets mang sắc xanh ngọc thạch quyến rũ, là bản hòa tấu bất ngờ giữa vị chua sáng rỡ của những trái chanh xanh căng mọng và hương thơm ấm áp, nồng nàn của húng quế. Từng lớp mousse được chăm chút tỉ mỉ, tạo nên sự đối lập hoàn hảo: mềm tan của kem mousse - giòn xốp của đế bánh, tinh khôi mà đầy mê hoặc. Một chiếc bánh dành cho những ai trân trọng khoảnh khắc thanh lọc, sảng khoái, yêu hương vị độc đáo và sống động – "La Cuisine Ngọt" gửi gắm cảm xúc qua từng muỗng bánh, như một làn gió hè tươi mát.', 
 '<ul>
   ...
   <li><b>Lớp 3 – Mousse Basilic (Mousse húng quế):</b> Lớp mousse nhẹ, xốp, thấm đượm hương thơm tinh tế của lá húng quế, tạo cảm giác bất ngờ và thanh thoát.</li>
   <li><b>Lớp 4 – Gelée chanh:</b> Một lớp gelée chanh mỏng, tăng độ tươi mới, cân bằng vị và tạo chiều sâu cho bánh.</li>
   <li><b>Lớp 5 – Miroir Glaze Vert:</b> Lớp phủ bóng màu xanh lá ngọc, giữ độ ẩm và tạo vẻ ngoài hấp dẫn, sang trọng.</li>
 </ul>
 <p>Trang trí bằng lát chanh tươi và lá húng quế (hoặc bạc hà), điểm xuyết chút đường bột tinh khôi, hoàn thiện vẻ đẹp thanh lịch của bánh.</p>', 
 '<ul class="no-dot">
   <li>Bảo quản bánh trong hộp kín, giữ ở ngăn mát tủ lạnh (2–6°C) để đảm bảo hương vị và kết cấu tốt nhất.</li>
   <li>Tránh để bánh tiếp xúc trực tiếp với ánh nắng hoặc nhiệt độ phòng quá lâu.</li>
   <li>Bánh ngon nhất khi dùng trong vòng 24 giờ kể từ lúc nhận.</li>
...
(3, 
 'Blanche Figues & Framboises', 
 1, 
 '<p>Có những ngày, chỉ cần một miếng bánh thôi cũng đủ khiến lòng nhẹ đi đôi chút. 
 Entremets Sung – Mâm Xôi – Sô Cô La Trắng là bản giao hưởng giữa vị chua thanh của mâm xôi, độ ngọt dịu của sung chín và sự béo mịn, thanh tao của sô cô la trắng.</p>
 <p>Từng lớp bánh đan xen mượt mà, tan chảy như sương đầu sáng – dịu dàng mà sâu lắng. 
 Bánh được tạo nên từ những nguyên liệu thượng hạng: sô cô la trắng Ivoire Valrhona, trái sung và mâm xôi tươi nhập khẩu, 
 cốt bánh nướng thủ công, cùng lớp compoté nấu chậm giữ trọn hương vị tự nhiên. 
 Mỗi thành phần đều được cân chỉnh tỉ mỉ để mang đến trải nghiệm vị giác tinh tế, trọn vẹn và đầy cảm xúc.</p>
 <p>Một chiếc bánh nhẹ như hơi thở, sang như bản nhạc Pháp, và ngọt ngào theo cách riêng của “La Cuisine Ngọt”.</p>', 
 650000, 
 750000, 
 10, 
 'available', 
 'assets/images/blanche-figues&framboises.jpg', 
 550, 
 3, 
 TRUE, 
 '<b>Sung – Mâm Xôi – Sô Cô La Trắng</b>', 
 ...
 '<ul>
   <li><b>Lớp 1 – Cốt bánh mâm xôi:</b> Bánh bông xốp mềm nhẹ, thấm vị chua thanh tự nhiên từ mâm xôi tươi, mang lại nền hương tươi sáng và cân bằng cho tổng thể.</li>
   <li><b>Lớp 2 – Compoté sung – mâm xôi:</b> Hỗn hợp trái cây được nấu chậm để giữ nguyên cấu trúc và hương vị tự nhiên, tạo nên điểm nhấn ngọt dịu xen lẫn chút chua thanh đầy cuốn hút.</li>
   <li><b>Lớp 3 – Mousse sô cô la trắng:</b> Mềm mượt, nhẹ bẫng như mây, với vị béo thanh tao của sô cô la trắng Ivoire Valrhona — lớp kết nối hoàn hảo giữa các tầng vị.</li>
   <li><b>Lớp 4 – Gương sô cô la trắng:</b> Phủ đều bề mặt bằng lớp glaçage mịn như lụa, tạo hiệu ứng bóng ánh ngọc trai, vừa đẹp mắt vừa giữ độ ẩm cho bánh.</li>
 </ul>
 <p>Trang trí bằng sung tươi, mâm xôi đỏ mọng và hoa edible — mang lại vẻ thanh thoát, tự nhiên, chuẩn phong cách “La Cuisine Ngọt”.</p>', 
 '<ul class="no-dot">
   <li>Bảo quản bánh trong hộp kín, giữ ở ngăn mát tủ lạnh (2–6°C) để đảm bảo hương vị và kết cấu tốt nhất.</li>
   <li>Tránh để bánh tiếp xúc trực tiếp với ánh nắng hoặc nhiệt độ phòng quá lâu.</li>
   <li>Bánh ngon nhất khi dùng trong vòng 24 giờ kể từ lúc nhận.</li>
...
(4, 
 'Mousse Chanh Dây', 
 2, 
 '<p>Bánh Mousse Chanh Dây là món tráng miệng tinh tế, mang đến cảm giác tươi mát và sảng khoái ngay từ muỗng đầu tiên. 
 Bánh hòa quyện hoàn hảo vị chua thanh của chanh dây với lớp mousse whipping mềm mịn, béo nhẹ, tan chảy trên đầu lưỡi mà vẫn giữ sự nhẹ nhàng, không ngấy.</p>
 <p>Về kết cấu, bánh mousse nổi bật với lớp bọt khí nhẹ nhàng, xốp mượt và tươi mới, 
 kết hợp cùng lớp đế cookie giòn rụm hoặc custard chua thanh, 
 tạo trải nghiệm vị giác cân bằng giữa mềm – giòn – chua – béo, 
 mang đến sự hài lòng trọn vẹn cho người thưởng thức.</p>', 
 550000, 
 600000, 
 25, 
 'available', 
 'assets/images/mousse-chanh-day.jpg', 
 450, 
 2, 
 TRUE, 
 '<b>Chanh dây – Whipping cream – Phô mai mascarpone</b>', 
 'Chiếc Mousse Chanh Dây là sự kết hợp tinh tế của hương vị nhiệt đới tươi mới. Lớp custard chua thanh hòa quyện cùng những miếng chanh dây mọng nước, 
 điểm xuyết lớp mousse whipping mềm mịn, béo nhẹ, tan ngay trên đầu lưỡi. Từng muỗng bánh mang đến trải nghiệm vị giác sống động,
  cân bằng hoàn hảo giữa chua – ngọt – béo, nhẹ nhàng mà đầy quyến rũ.', 
 '<ul>
   <li><b>Lớp 1 – Đế bánh (Base Cookie / Biscuit):</b> Đế bánh giòn rụm, thơm bơ nhẹ nhàng, tạo nền chắc chắn cho các lớp mousse mềm mịn phía trên, đồng thời mang đến cảm giác tan giòn thú vị khi thưởng thức.</li>
   <li><b>Lớp 2 – Kem chanh dây kết hợp Whipping & Phô mai mascarpone (Passion Fruit Whipping & Mascarpone Mousse):</b> Lớp mousse mềm mượt, béo nhẹ và chua thanh từ chanh dây, hòa quyện cùng mascarpone, tạo sự cân bằng hoàn hảo giữa ngọt – béo – chua, tan chảy trên đầu lưỡi.</li>
   <li><b>Lớp 3 – Chanh dây với gelatin (Passion Fruit Gelée):</b> Lớp gelée chanh dây tươi mát, hơi sánh nhẹ, giữ vị chua thanh, tạo điểm nhấn trong từng muỗng bánh và làm tăng độ sống động, tươi mới cho trải nghiệm vị giác.</li>
 </ul>', 
 '<ul class="no-dot">
   <li>Bảo quản bánh trong hộp kín, giữ ở ngăn mát tủ lạnh (2–6°C) để đảm bảo hương vị và kết cấu tốt nhất.</li>
   <li>Tránh để bánh tiếp xúc trực tiếp với ánh nắng hoặc nhiệt độ phòng quá lâu.</li>
...
(5,
 'Mousse Dưa Lưới',
 2,
 '<p>Ra đời giữa những ngày oi ả của Sài Gòn, chiếc Bánh Dưa Lưới như mang đến một khoảng trời mát lành và thanh khiết. Lớp mousse mềm mại từ phô mai tươi và kem sữa hòa quyện hoàn hảo với dưa lưới mật Fuji nấu chậm, bên trong là những miếng dưa tươi mọng cùng cốt bánh gato vani ẩm mềm và một chút rượu dưa lưới nồng nàn, tạo nên hương vị tinh tế, dịu dàng nhưng đầy ấn tượng.</p>
 <p>Màu xanh mát lành của bánh kết hợp với những cụm dưa tươi trang trí trên bề mặt vừa đủ để thu hút ánh nhìn, vừa gợi lên sự tò mò khi chạm dao vào từng miếng bánh mong manh. Khi thưởng thức, vị mềm mượt, mát lành và thanh thoát của dưa lưới tan dần trên đầu lưỡi, nhấn nhá bởi chút ngọt dịu và hương thơm tinh tế của kem phô mai, đem lại trải nghiệm vị giác sống động, tươi mới và khó quên.</p>',
 550000,
 600000,
 20,
 'available',
 'assets/images/mousse-dua-luoi.jpg',
 450,
 2,
 TRUE,
 '<b>Dưa lưới hữu cơ – Kem sữa – Phô mai Mascarpone</b>',
 'Bánh có vị thơm và béo nhẹ nhàng từ phô mai tươi kết hợp cùng kem sữa và dưa lưới mật Fuji nấu chậm, bên trong là rất nhiều dưa lưới tươi và cốt bánh gato vani, cùng với một ít rượu dưa lưới nồng nàn. Cũng đơn giản như chính cái tên, Mousse Dưa Lưới vừa đủ gây ấn tượng khi nhìn vào màu xanh mát lành tinh tươm với những cụm dưa tươi mát được trang trí bên ngoài, vừa đủ để bạn có đôi chút ngập ngừng khi chạm dao vào từng miếng bánh mong manh.',
 '<ul>
   <li><b>Lớp 1 – Bánh bông lan vị vani (Vanilla Génoise):</b> Đế bánh xốp mềm, ẩm mượt, thơm nhẹ hương vani tự nhiên, tạo nền chắc chắn nhưng vẫn thanh thoát, cân bằng vị ngọt của các lớp mousse và dưa lưới phía trên.</li>
   <li><b>Lớp 2 – Dưa lưới mật tươi thái hạt lựu (Fresh Melon Cubes):</b> Những miếng dưa lưới mật tươi, căng mọng, thái hạt lựu vừa ăn, giữ nguyên vị ngọt thanh tự nhiên và kết cấu giòn nhẹ, tạo điểm nhấn tươi mát giữa các lớp bánh.</li>
   <li><b>Lớp 3 – Mousse dưa lưới (Melon Mousse):</b> Mousse dưa lưới mềm mượt, béo nhẹ, tan chảy trên đầu lưỡi, hòa quyện hoàn hảo với dưa tươi bên dưới, mang đến trải nghiệm vị giác dịu dàng, tươi mát và đầy tinh tế.</li>
 </ul>',
 '<ul class="no-dot">
   <li>Bảo quản bánh trong hộp kín, giữ ở ngăn mát tủ lạnh (2–6°C) để đảm bảo hương vị và kết cấu tốt nhất.</li>
   <li>Tránh để bánh tiếp xúc trực tiếp với ánh nắng hoặc nhiệt độ phòng quá lâu.</li>
...
(
  ...
  'Mousse Việt Quất',
  2,
  '<p>Bánh Mousse Việt Quất là sự kết hợp hoàn hảo giữa vị chua nhẹ thanh mát của quả việt quất và vị béo ngậy của kem tươi. Lớp mousse mịn màng, tan ngay trong miệng, mang lại cảm giác nhẹ nhàng, tươi mới nhưng vẫn đậm đà hương vị tự nhiên.</p>
  <p>Bánh có màu tím than đặc trưng của việt quất, được điểm xuyết bằng những quả tươi mọng phủ trên mặt — tạo nên vẻ ngoài vừa tinh tế, vừa sang trọng. Đây là lựa chọn hoàn hảo cho những ai yêu thích vị ngọt thanh và cảm giác mát lạnh đặc trưng của dòng bánh mousse cao cấp.</p>
  <p>Mỗi miếng bánh là sự kết hợp tinh tế giữa vị ngọt dịu và hương thơm tự nhiên của việt quất — nhẹ nhàng, tinh khiết và đầy cảm hứng.</p>',
  550000,
  600000,
  18,
  'available',
  'assets/images/mousse-viet-quat.jpg',
  450,
  2,
  FALSE,
  '<b>Việt quất – Whipping cream – Cream cheese</b>',
  'Mousse Việt Quất chinh phục vị giác bằng sắc tím quyến rũ và hương vị trái cây thanh mát. Lớp mousse mềm mượt, hòa quyện cùng vị chua nhẹ, mang lại cảm giác thanh tao và dễ chịu. Mỗi miếng bánh là sự kết hợp tinh tế giữa vị ngọt dịu và hương thơm tự nhiên của việt quất — nhẹ nhàng, tinh khiết và đầy cảm hứng.',
  '<ul>
    <li><b>Lớp 1 – Đế bánh (Base Cookie / Biscuit):</b> Đế bánh giòn rụm, thơm bơ nhẹ nhàng, tạo nền chắc chắn cho các lớp mousse mềm mịn phía trên, đồng thời mang đến cảm giác tan giòn thú vị khi thưởng thức.</li>
    <li><b>Lớp 2 – Mousse Việt Quất:</b> Lớp mousse tím nhạt mịn màng như nhung, hòa quyện giữa vị chua thanh của việt quất tươi và vị béo nhẹ của kem whipping & cream cheese, tạo cảm giác cân bằng hoàn hảo.</li>
    <li><b>Lớp 3 – Gelée Việt Quất:</b> Lớp thạch mềm trong veo từ nước cốt việt quất nguyên chất, làm nổi bật sắc tím quyến rũ và vị chua thanh tươi mát, mang đến điểm nhấn hài hòa cho tổng thể chiếc bánh.</li>
    <li><b>Trang trí:</b> Phủ việt quất tươi mọng nước, điểm xuyết lá bạc hà và bụi đường tuyết nhẹ, tôn lên vẻ sang trọng và tinh tế.</li>
  </ul>',
  '<ul class="no-dot">
    <li>Bảo quản bánh trong hộp kín, giữ ở ngăn mát tủ lạnh (2–6°C) để đảm bảo hương vị và kết cấu tốt nhất.</li>
    <li>Tránh để bánh tiếp xúc trực tiếp với ánh nắng hoặc nhiệt độ phòng quá lâu.</li>
...
(7, 
 'Orange Serenade', 
 3, 
 '<p>Orange Serenade được lấy cảm hứng từ tách trà Earl Grey ấm áp và lát cam tươi mát của mùa hè. Cốt bánh được ủ cùng trà bá tước, mang lại hương trà dịu nhẹ, thanh thoát. Xen giữa các lớp bánh là phần xốt cam chua ngọt và kem phô mai béo mịn — hòa quyện vừa đủ để tạo nên vị ngọt thanh, tròn đầy. Ẩn trong nhân là lớp thạch cam trong veo, dẻo nhẹ, mang hương vị cam tự nhiên giúp cân bằng vị béo, tạo điểm nhấn tươi mát cho tổng thể chiếc bánh. Một chiếc bánh nhẹ nhàng nhưng không hề đơn điệu — hoàn hảo cho những buổi trà chiều, tiệc sinh nhật, hay khi bạn muốn tự thưởng cho mình một món ngọt tinh tế.</p>', 
 550000, 
 600000, 
 15, 
 'available', 
 'assets/images/orange-serenade.jpg', 
 600, 
 3, 
 FALSE, 
 '<b>Cam tươi, Earl Grey, kem phô mai, whipping cream</b>', 
 'Chiếc bánh là sự kết hợp thanh tao giữa vị trà bá tước Earl Grey dịu nhẹ và vị cam tươi sáng chua ngọt. Cảm giác béo mịn, thoang thoảng hương trà và thoảng vị cam mọng nước như một buổi chiều hè dịu nắng – nhẹ nhàng, thư thái mà tinh tế.', 
 '<ul>
   <li><b>Lớp 1 – Gato trà bá tước (Earl Grey sponge):</b> Cốt bánh mềm ẩm, được ủ cùng trà bá tước, hương thơm thanh và thoang thoảng vị trà dịu.</li>
   <li><b>Lớp 2 – Jelly cam (Orange jelly):</b> Thạch cam trong suốt, mát lạnh và dẻo nhẹ, mang vị cam tươi tự nhiên, giúp cân bằng vị béo.</li>
   <li><b>Lớp 3 – Kem phô mai cam (Orange cream cheese):</b> Kem phô mai chua nhẹ, béo mịn, quyện cùng sốt cam nấu tay cho hương vị ngọt thanh, tròn đầy.</li>
   <li><b>Lớp 4 – Earl Grey cream:</b> Lớp kem trà bá tước mịn mượt đệm giữa các tầng, giúp vị trà lan tỏa khắp chiếc bánh.</li>
   <li><b>Lớp 5 – Sweet tangy orange sauce:</b> Xốt cam tươi sáng, chua ngọt nhẹ, phủ đều mặt bánh như điểm nhấn của sắc cam và hương trà.</li>
  </ul>', 
 '<ul class="no-dot">
   <li>Bảo quản bánh trong hộp kín, giữ ở ngăn mát tủ lạnh (2–6°C) để đảm bảo hương vị và kết cấu tốt nhất.</li>
   <li>Tránh để bánh tiếp xúc trực tiếp với ánh nắng hoặc nhiệt độ phòng quá lâu.</li>
...
(8, 
 ...
 3, 
 '<p>Strawberry Cloud Cake là chiếc bánh mang phong vị tươi sáng của những trái dâu mọng và việt quất ngọt thanh, kết hợp cùng lớp kem tươi mềm nhẹ và cốt bánh vani thơm dịu. Mỗi lát bánh là sự giao hòa giữa vị trái cây tươi mát, vị ngọt dịu của kem và cốt bánh ẩm mịn, tạo nên cảm giác trong trẻo và đầy sức sống. Không chỉ là món tráng miệng, đây là chiếc bánh mang đến cảm giác thư giãn và ngọt ngào — hoàn hảo cho tiệc sinh nhật, trà chiều hay những dịp bạn muốn gửi tặng điều dễ thương nhất.</p>', 
 500000, 
 550000, 
 12, 
 'available', 
 'assets/images/strawberry-cloud-cake.jpg', 
 650, 
 3, 
 FALSE, 
 '<b>Dâu tươi, việt quất, kem tươi Pháp, cốt bánh vanilla mềm ẩm</b>', 
 'Chiếc bánh kem mang sắc trắng thanh khiết, điểm xuyết tầng dâu đỏ và việt quất xanh tím rực rỡ. Từng lớp bánh là sự hòa quyện giữa vị béo nhẹ của kem tươi, vị ngọt thanh của trái cây và cốt bánh vanilla mềm mịn — đơn giản mà tinh tế, như một áng mây ngọt ngào dành tặng những khoảnh khắc yêu thương.', 
 '<ul>
   <li><b>Lớp 1 – Cốt bánh vanilla mềm ẩm:</b> Lớp nền truyền thống được làm từ bột mì, trứng tươi, bơ lạt và tinh chất vani tự nhiên. Bánh được nướng vừa tới, cho kết cấu mềm, xốp, thơm dịu. Khi cắt ra, từng thớ bánh nhẹ tơi, mang lại cảm giác êm ái nơi đầu lưỡi — là nền hoàn hảo để nâng đỡ các tầng kem tươi và trái cây phía trên.</li>
   <li><b>Lớp 2 – Kem tươi whipping nhẹ béo:</b> Được đánh bông mềm từ kem sữa tươi, vị ngọt dịu và độ béo vừa phải, không ngấy. Lớp kem này ôm lấy từng lát bánh, tạo cảm giác mịn màng và tan ngay khi thưởng thức. Đây là “trái tim” giúp toàn bộ chiếc bánh trở nên hài hòa, mềm mại và tinh tế.</li>
   <li><b>Lớp 3 – Mặt bánh phủ dâu tây & việt quất tươi:</b> Những lát dâu tây mọng nước kết hợp cùng việt quất căng tròn, được sắp đều trên mặt bánh như một khu vườn nhỏ rực rỡ. Vị ngọt thanh xen lẫn chua nhẹ giúp cân bằng vị béo của kem, mang lại cảm giác tươi mát, tự nhiên và đầy sức sống.</li>
  </ul>', 
 '<ul class="no-dot">
   <li>Bảo quản bánh trong hộp kín, giữ ở ngăn mát tủ lạnh (2–6°C) để đảm bảo hương vị và kết cấu tốt nhất.</li>
   <li>Tránh để bánh tiếp xúc trực tiếp với ánh nắng hoặc nhiệt độ phòng quá lâu.</li>
...
(9, 
 'Earl Grey Bloom', 
 3, 
 '<p>Earl Grey Bloom là bản hòa ca của trà, trái cây và hương hoa – chiếc bánh dành riêng cho những ai yêu nét đẹp nhẹ nhàng, thanh lịch. Cốt bánh mềm mịn được ủ với lá trà bá tước hảo hạng, tỏa hương thơm thanh mát đặc trưng của cam bergamot. Lớp nhân giữa là sự kết hợp của xoài vàng mọng nước và dâu tây tươi ngọt thanh, giúp làm nổi bật vị trà nhẹ nhàng nhưng sâu lắng. Bên ngoài là lớp kem whipping mịn màng, được đánh bông nhẹ, phủ đều và trang trí tinh tế bằng trái cây khô, rosemary xanh và hoa nhỏ – vừa tự nhiên vừa sang trọng. Từng lát bánh mang lại cảm giác tươi sáng, dễ chịu – thích hợp cho những buổi tiệc sinh nhật, trà chiều hoặc làm quà tặng tinh tế dành cho phái đẹp.</p>', 
 500000, 
 550000, 
 10, 
 'available', 
 'assets/images/earl-grey-bloom.jpg', 
 650, 
 3, 
 TRUE, 
 '<b>Trà bá tước, xoài tươi, dâu tây, whipping cream</b>', 
 'Chiếc bánh là phiên bản đặc biệt của dòng Earl Grey cake được yêu thích tại La Cuisine Ngọt – mang hương vị thanh nhã, nhẹ nhàng và đầy nữ tính. Lớp cốt trà bá tước thơm dịu kết hợp cùng vị trái cây tươi chua ngọt, tạo nên tổng thể hài hòa, tinh tế và dễ chịu.', 
 '<ul>
   <li><b>Lớp 1 – Cốt bánh Earl Grey:</b> Bông lan mềm ẩm, ủ cùng trà bá tước thượng hạng, thoảng hương cam bergamot dịu nhẹ. Khi thưởng thức, vị trà thanh và ấm lan tỏa nhẹ nhàng, làm nền cho tổng thể bánh.</li>
   <li><b>Lớp 2 – Nhân trái cây tươi:</b> Gồm xoài chín vàng và dâu tây tươi, được xen kẽ giữa các lớp cốt bánh. Xoài ngọt thanh hòa cùng vị chua nhẹ của dâu giúp cân bằng vị béo, tạo nên cảm giác tươi mát, dễ chịu.</li>
   <li><b>Lớp 3 – Kem Earl Grey:</b> Kem whipping mịn nhẹ, pha cùng chiết xuất trà bá tước và vanilla tự nhiên. Vị kem béo dịu, tan nhanh nơi đầu lưỡi, kết nối hài hòa giữa trà thơm và trái cây tươi.</li>
  </ul>', 
 '<ul class="no-dot">
   <li>Bảo quản bánh trong hộp kín, giữ ở ngăn mát tủ lạnh (2–6°C) để đảm bảo hương vị và kết cấu tốt nhất.</li>
   <li>Tránh để bánh tiếp xúc trực tiếp với ánh nắng hoặc nhiệt độ phòng quá lâu.</li>
