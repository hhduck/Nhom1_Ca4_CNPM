...
(10, 'Nón Sinh Nhật', 4, '<p>Nón sinh nhật xinh xắn</p>', 10000, 10000, 200, 'available', 'assets/images/non.jpg', 20, 365, FALSE, '', '', '', '', ''),
(11, 'Pháo Hoa', 4, '<p>Pháo hoa trang trí bánh</p>', 55000, 55000, 150, 'available', 'assets/images/phaohoa.jpg', 50, 365, FALSE, '', '', '', '', ''),
(12, 'Bóng Bay và Dây Trang Trí', 4, '<p>Set bóng bay và dây trang trí</p>', 40000, 40000, 100, 'available', 'assets/images/trang-tri.jpg', 100, 365, FALSE, '', '', '', '', '');
...
-- Đơn 4
(4, 7, 'Orange Serenade', 550000, 1, 550000, NULL),
(4, 8, 'Strawberry Cloud Cake', 500000, 1, 500000, NULL),
